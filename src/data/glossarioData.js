...
export const glossarioMockData = [
  ...
  { id: 2, nome: "Airbag", icone: "/images/luzes-no-painel/airbag.png", cor: "laranja", descricao: "Falha no sistema de airbag/cintos.", causas: ["Sensor de impacto com defeito"], acoes: ["Diagnóstico especializado"] },
  { id: 3, nome: "Alerta de Segurança", icone: "/images/luzes-no-painel/alerta-seguranca.png", cor: "laranja", descricao: "Alerta geral de segurança; verifique outros avisos.", causas: ["Falha em sensores"], acoes: ["Consultar manual", "Procurar assistência"] },
  ...
  { id: 5, nome: "Capô Aberto", icone: "/images/luzes-no-painel/capo-aberto.png", cor: "laranja", descricao: "Capô aberto ou mal fechado.", causas: ["Capô não fechado"], acoes: ["Fechar corretamente"] },
  ...
  { id: 11, nome: "Falha de Iluminação", icone: "/images/luzes-no-painel/falha-luzes.png", cor: "vermelho", descricao: "Problema em luzes externas.", causas: ["Lâmpadas queimadas"], acoes: ["Verificar e substituir lâmpadas"] },
  ...
  { id: 18, nome: "Injeção / Check Engine", icone: "/images/luzes-no-painel/injecao_eletronica.png", cor: "amarelo", descricao: "Falha detectada no sistema de injeção/emissão.", causas: ["Algum mau funcionamento relacionado ao motor"], acoes: ["Diagnóstico OBD-II"] },
  ...
  { id: 20, nome: "Óleo do Motor", icone: "/images/luzes-no-painel/oleo-do-motor.png", cor: "vermelho", descricao: "Pressão ou nível de óleo crítico.", causas: ["Nível de óleo baixo", "Baixo nivel de óleo"], acoes: ["PARE e verificar nível de óleo"] },
  ...
  { id: 22, nome: "Pisca Alerta", icone: "/images/luzes-no-painel/pisca-alerta.png", cor: "laranja", descricao: "Pisca-alerta ativado.", causas: ["Ativado pelo motorista"], acoes: ["Usar em emergência"] },
  { id: 23, nome: "Porta Aberta", icone: "/images/luzes-no-painel/porta-aberta.png", cor: "amarelo", descricao: "Porta aberta ou mal fechada.", causas: ["Porta não fechada"], acoes: ["Fechar a porta"] },
  { id: 24, nome: "Porta-malas Aberto", icone: "/images/luzes-no-painel/porta-malas-aberto.png", cor: "amarelo", descricao: "Porta-malas aberto.", causas: ["Travamento não encaixado"], acoes: ["Fechar compartimento"] },
  ...
  { id: 27, nome: "Reserva de Combustível", icone: "/images/luzes-no-painel/reserva-de-combustivel.png", cor: "laranja", descricao: "Nível de combustível baixo.", causas: ["Nível de combustivel na reserva"], acoes: ["Abastecer o quanto antes"] },
  ...
  { id: 30, nome: "Temperatura do Motor", icone: "/images/luzes-no-painel/temperatura-do-motor.png", cor: "vermelho", descricao: "Superaquecimento do motor.", causas: ["Baixo nível de líquido de arrefecimento", "Falha no eletroventilador do radiador"], acoes: ["PARE e desligue o motor"] }
];
